...
import time
import requests
from .scraper import get_page, scrap_blog1, get_site_content
...
class NewsApi(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response(scrap_blog1(page_to_scrap), status=status.HTTP_200_OK)
    ...
    def post(self, request, *args, **kwargs):
        ...
        resp = get_site_content(page_to_scrap)
